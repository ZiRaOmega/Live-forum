...
func sqlMaker() {
	if !fileExists("sqlite-database.db") {
		...
		insertUser(sqliteDatabase, "Ulrik", "zaudh@zjd.com", "a", "cat.jpg", "Administrator")
		insertUser(sqliteDatabase, "Clément", "huazdh@jadz.com", "b", "bird.img", "Administrator")
		insertUser(sqliteDatabase, "Maxime", "huazzedh@jadz.com", "test", "zidj.jpg", "Administrator")
		insertUser(sqliteDatabase, "Bozo", "huazeazdh@jadz.com", "d", "zhdu.img", "Moderator")
		insertUser(sqliteDatabase, "Balou", "BalBal@jadz.com", "balourde", "bam.img", "User")
